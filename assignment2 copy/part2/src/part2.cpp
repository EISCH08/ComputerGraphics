...
void drawMesh(Context &ctx, GLuint program, const MeshVAO &meshVAO)
{
    ...
    // Define the model, view, and xprojection matrices here
    ...
    model = trackballGetRotationMatrix(ctx.trackball);
    view = glm::lookAt(glm::vec3(0.0f,0.0f,-4.0f),glm::vec3(0.0f,0.0f,0.0f),glm::vec3(0.0f,1.0f,0.0f));
    projection = glm::perspective((3.14f/4.0f),1.0f,0.1f,100.0f);
    glBindVertexArray(meshVAO.vao);
